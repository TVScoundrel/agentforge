...
- `relational-get-schema` tool returns database schema: Complete
- Lists all tables in the database: Complete
- Lists columns for each table with types: Complete
- Includes primary key and foreign key information: Complete
- Includes index information: Complete
- Works across PostgreSQL, MySQL, and SQLite: Complete (vendor-specific introspection implemented for all three vendors; SQLite integration verified in runtime tests)
- Cached schema with TTL (configurable): Complete
