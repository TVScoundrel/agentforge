...
### Schema Validation Tests (17 total)
...
### Tool Invocation Tests (10 total)
- 2 always-run validation tests
- 8 integration tests requiring SQLite bindings
- Empty table name rejection
- Empty connection string rejection
...
- [x] Create unit tests (17 schema + 10 invocation = 27 total)
