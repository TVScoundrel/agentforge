...
::: tip Agent Skills
The Agent Skills system has moved to its own package. See the **[@agentforge/skills API Reference](/api/skills)** for SkillRegistry, TrustLevel, events, and all skill-related APIs.
:::
