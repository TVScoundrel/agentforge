...
- [x] Add/update focused tests for planning, execution, replanning, and node-level error handling
  - `pnpm test --run packages/patterns/tests/plan-execute/nodes.test.ts packages/patterns/tests/plan-execute/deduplication.test.ts packages/patterns/tests/plan-execute/agent.test.ts packages/patterns/tests/plan-execute/integration.test.ts packages/patterns/tests/plan-execute/state.test.ts` -> `5 passed` files, `50 passed` tests
- [x] Record explicit-`any` warning deltas for touched files in story docs
