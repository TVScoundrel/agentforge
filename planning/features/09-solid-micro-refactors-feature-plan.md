...
**Active Story:** ST-09031 (In Progress)
...
- `ST-09031` is now in progress, extracting the remaining tool-registry registration, update, removal, and bulk-registration paths into a focused internal helper while preserving the stable public facade and event semantics.
