...
| [@agentforge/tools](./packages/tools) | 0.3.9 | Standard tool library (68 production-ready tools) | [![npm](https://img.shields.io/npm/v/@agentforge/tools)](https://www.npmjs.com/package/@agentforge/tools) |
