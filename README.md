...
[![Tests](https://img.shields.io/badge/tests-2503%20passing-success)](./packages)
...
- **Comprehensive Tests** - 2503 tests passing across all packages
...
|---------|---------|-------------|-----|
| [@agentforge/core](./packages/core) | 0.16.71 | Core abstractions (tools, registry, LangGraph utilities, middleware, streaming, resources, monitoring) | [![npm](https://img.shields.io/npm/v/@agentforge/core)](https://www.npmjs.com/package/@agentforge/core) |
| [@agentforge/patterns](./packages/patterns) | 0.16.71 | Agent patterns (ReAct, Plan-Execute, Reflection, Multi-Agent) | [![npm](https://img.shields.io/npm/v/@agentforge/patterns)](https://www.npmjs.com/package/@agentforge/patterns) |
| [@agentforge/tools](./packages/tools) | 0.16.71 | Standard tool library (81 production-ready tools) | [![npm](https://img.shields.io/npm/v/@agentforge/tools)](https://www.npmjs.com/package/@agentforge/tools) |
| [@agentforge/skills](./packages/skills) | 0.16.71 | Agent Skills system (SKILL.md discovery, activation, trust policies) | [![npm](https://img.shields.io/npm/v/@agentforge/skills)](https://www.npmjs.com/package/@agentforge/skills) |
| [@agentforge/testing](./packages/testing) | 0.16.71 | Testing utilities (mocks, assertions, fixtures) | [![npm](https://img.shields.io/npm/v/@agentforge/testing)](https://www.npmjs.com/package/@agentforge/testing) |
| [@agentforge/cli](./packages/cli) | 0.16.71 | CLI tool (156 tests, 98.11% coverage) | [![npm](https://img.shields.io/npm/v/@agentforge/cli)](https://www.npmjs.com/package/@agentforge/cli) |
...
**AgentForge v0.16.71 - Published on npm and Production-Ready!**
...
- **Total Tests**: 2503 passing across all packages
