...
|---------|---------|-------------|-----|
| [@agentforge/core](./packages/core) | 0.6.3 | Core abstractions (tools, registry, LangGraph utilities, middleware, streaming, resources, monitoring) | [![npm](https://img.shields.io/npm/v/@agentforge/core)](https://www.npmjs.com/package/@agentforge/core) |
| [@agentforge/patterns](./packages/patterns) | 0.6.3 | Agent patterns (ReAct, Plan-Execute, Reflection, Multi-Agent) | [![npm](https://img.shields.io/npm/v/@agentforge/patterns)](https://www.npmjs.com/package/@agentforge/patterns) |
| [@agentforge/tools](./packages/tools) | 0.6.3 | Standard tool library (70 production-ready tools) | [![npm](https://img.shields.io/npm/v/@agentforge/tools)](https://www.npmjs.com/package/@agentforge/tools) |
| [@agentforge/testing](./packages/testing) | 0.6.3 | Testing utilities (mocks, assertions, fixtures) | [![npm](https://img.shields.io/npm/v/@agentforge/testing)](https://www.npmjs.com/package/@agentforge/testing) |
| [@agentforge/cli](./packages/cli) | 0.6.3 | CLI tool (156 tests, 98.11% coverage) | [![npm](https://img.shields.io/npm/v/@agentforge/cli)](https://www.npmjs.com/package/@agentforge/cli) |
...
**🎉 AgentForge v0.6.3 - Published on npm and Production-Ready!**
